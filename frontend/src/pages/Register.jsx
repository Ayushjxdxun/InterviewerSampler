      ...
      <div className='w-full max-w-md bg-white p-6 sm:p-10 border border-gray-200 rounded-2xl shadow-xl' >
        ...
        <form onSubmit={onSubmit} className='grid grid-cols-1 gap-4'>
          <div className='space-y-1'>
            ...
            <input type="text" name="name" value={name} className='w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 outline-none transition-all ' placeholder='Ayush Jadaun' onChange={onChange} required />
          </div>
          <div className='space-y-1'>
            <label className='text-[10px] font-bold uppercase text-gray-400 ml-1'>Email</label>
            <input type="email" name="email" value={email} className='w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 outline-none transition-all ' placeholder='jadaunayush26@gmail.com' onChange={onChange} required />
