...
function SessionReview() {
    ...
    const barData = {
        ...
        datasets: [{
            ...
            data: questions.map(q => normalizeDisplayScore(q.technicalScore)),
            backgroundColor: questions.map(q => normalizeDisplayScore(q.technicalScore) > 70 ? '#10b981' : '#f59e0b'),
            borderRadius: 8,
        }],
    };
                                ...
                                <div className="flex flex-col lg:flex-row justify-between items-start gap-4 sm:gap-6">
                                    ...
                                    <div className="flex gap-2 shrink-0">
                                        <div className="px-3 py-1.5 sm:px-5 sm:py-2 rounded-xl sm:rounded-2xl border flex items-center gap-2 bg-emerald-50 border-emerald-100">
                                            ...
                                            <span className="text-xs sm:text-sm font-black text-emerald-600">{normalizeDisplayScore(q.technicalScore)}%</span>
                                        </div>
                                        <div className="px-3 py-1.5 sm:px-5 sm:py-2 rounded-xl sm:rounded-2xl border border-blue-50 bg-blue-50/30 flex items-center gap-2">
                                            ...
                                            <span className="text-xs sm:text-sm font-black text-blue-600">{normalizeDisplayScore(q.confidenceScore)}%</span>
                                        </div>
                                    </div>
                                </div>
